...
fun IntroShowcaseScope.Navigation(
    ...
    NavHost(
        ...
        composable(
            ...
            AnimatedScreen(tier = AnimationTier.Tier2) {
                CategoriesScreen(
                    showAddSheetInitially =
                        backStackEntry.arguments?.getBoolean("showBottomSheet") == true,
                    isPicker =
                        backStackEntry.arguments?.getBoolean("showCategorySelection") == true,
                    onCategorySelected = {
                        navController.previousBackStackEntry
                            ?.savedStateHandle
                            ?.set("new_category", it)
        ...
        composable("allTransactions?categoryId={categoryId}",
            arguments = listOf(
